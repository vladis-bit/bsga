      ...
      <div className="fixed bottom-0 inset-x-0 z-40 md:hidden px-3 pb-[env(safe-area-inset-bottom)] pointer-events-none">
        <div className="flex items-center gap-3 p-3 pointer-events-auto">
          <a
            ...
            className="group flex flex-1 items-center justify-center gap-2 rounded-2xl bg-gradient-to-b from-secondary to-muted px-3 py-3 text-xs font-bold text-foreground shadow-[0_4px_0_0_hsl(var(--border)),0_6px_12px_rgba(0,0,0,0.25)] ring-1 ring-inset ring-foreground/10 transition-all duration-150 hover:-translate-y-1 hover:from-muted hover:to-secondary hover:shadow-[0_6px_0_0_hsl(var(--border)),0_10px_20px_rgba(0,0,0,0.3)] active:translate-y-[2px] active:shadow-[0_2px_0_0_hsl(var(--border)),0_3px_6px_rgba(0,0,0,0.2)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-2 focus-visible:ring-offset-primary"
          >
