...
const EducationBlog = () => {
  return (
    <>
      <Helmet>
        <title>BSGA Blog | Edukačné centrum | BSGA</title>
        <meta name="description" content="BSGA Blog - novinky a články zo sveta golfu." />
      </Helmet>
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="flex flex-col items-center justify-center text-center py-16">
              <div className="p-6 rounded-2xl bg-gold/10 mb-6">
                <Newspaper className="h-16 w-16 text-gold" />
              </div>
              <h2 className="text-2xl font-semibold text-foreground mb-4">
                Už čoskoro
              </h2>
              <p className="text-muted-foreground max-w-md">
                Pripravujeme pre vás zaujímavé články, novinky a tipy zo sveta golfu. Sledujte nás!
              </p>
            </div>
          </div>
        </section>
