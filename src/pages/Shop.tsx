  ...
  return (
    <>
      ...
      <AuroraBackground className="min-h-screen bg-primary text-primary-foreground" showRadialGradient={false}>
        <main>
          <section className="relative w-full bg-transparent pt-24 sm:pt-28 md:pt-32 pb-8 sm:pb-10 md:pb-12">
            <div className="container mx-auto px-4 sm:px-6">
              <div className="flex flex-col items-center gap-4 sm:gap-6 text-center">
                <span className="text-gold text-xs sm:text-sm tracking-[0.15em] sm:tracking-[0.2em] uppercase">
                  E-shop
                </span>
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-primary-foreground tracking-tight font-sans">
                  Obchod
                </h1>
                ...
                <div className="relative h-10 sm:h-12 md:h-16 overflow-hidden">
                  <AnimatePresence mode="wait">
                    <motion.span
                      key={titleNumber}
                      className="block whitespace-nowrap text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif font-semibold text-gold"
                ...
                <p className="text-sm sm:text-base md:text-lg text-primary-foreground/70 max-w-md sm:max-w-2xl text-center leading-relaxed px-4">
                  Darčekové poukážky, golfové služby a pripravovaný merch na jednom mieste.
                </p>
              </div>
            </div>
          </section>
